  ...
  setup() {
    onMounted(() => {
      ...
      // marker monito
        ...
        var el = document.createElement("div");
        el.className = "marker";
        el.style.backgroundImage = `url(` + "https://img.icons8.com/ultraviolet/344/walking.png" + `)`;
        el.style.width = "50px";
        ...
        //Marker
        const algoalgo = new mapboxgl.Marker(el);
        algoalgo.setLngLat([-71.23294338288471, -35.00200300963659]);
        algoalgo.setPopup(pop);
        algoalgo.addTo(map);

        algoalgo.setDraggable(true)

  

        

      algoalgo.getElement().addEventListener("click", () => {
      var posi = "["+algoalgo.getLngLat().lng+", "+algoalgo.getLngLat(). lat+"]"
      var posi2 = algoalgo.getLngLat().toArray();
       algoalgo.getPopup().setText(""+posi);
        var rutaCACA  = [
        posi2,
        [-71.22994865395084, -35.00156334164443],
        [-71.23051187712394, -35.0019471982832],
   ...
   /*  algoalgo.on('dragstart', function () {
      ...
      function crearMarkersEdificios() {
        ...
        entrada.getElement().addEventListener("click", () => {
          entrada = agregarMarker2(coordenada2);
        ...
        minas.getElement().addEventListener("click", () => {
          minas = agregarMarker2(coordenada3);
          // map.zoomTo(20.01,[-71.230,-35.003] );
          // AÑADIR UNA LINEA DESDE LA ENTRADA AL GIMNASIO LETS GOOOOOOOO
          muestrate.value = !muestrate.value;
          //crearRuta(rutaGim);
        ...
        mecanica.getElement().addEventListener("click", () => {
          mecanica = agregarMarker2(coordenada4);
        ...
        construccion.getElement().addEventListener("click", () => {
          construccion = agregarMarker2(coordenada5);
        ...
        auditorio.getElement().addEventListener("click", () => {
          auditorio = agregarMarker2(coordenada6);
        ...
        facultad.getElement().addEventListener("click", () => {
          facultad = agregarMarker2(coordenada7);
          // map.zoomTo(20.01,[-71.230,-35.003] );
          // AÑADIR UNA LINEA DESDE LA ENTRADA AL GIMNASIO LETS GOOOOOOOO
          muestrate.value = !muestrate.value;
          //crearRuta(rutaGim);
        ...
        laboratorio.getElement().addEventListener("click", () => {
          laboratorio = agregarMarker2(coordenada8);
          // map.zoomTo(20.01,[-71.230,-35.003] );
          // AÑADIR UNA LINEA DESDE LA ENTRADA AL GIMNASIO LETS GOOOOOOOO
          muestrate.value = !muestrate.value;
          //crearRuta(rutaGim);C
        ...
        bienestar.getElement().addEventListener("click", () => {
          bienestar = agregarMarker2(coordenada9);
          // map.zoomTo(20.01,[-71.230,-35.003] );
          // AÑADIR UNA LINEA DESDE LA ENTRADA AL GIMNASIO LETS GOOOOOOOO
          muestrate.value = !muestrate.value;
          //crearRuta(rutaGim);
        ...
        biblioteca.getElement().addEventListener("click", () => {
          biblioteca = agregarMarker2(coordenada10);
          // map.zoomTo(20.01,[-71.230,-35.003] );
          // AÑADIR UNA LINEA DESDE LA ENTRADA AL GIMNASIO LETS GOOOOOOOO
          muestrate.value = !muestrate.value;
          //crearRuta(rutaGim);
        ...
        electrica.getElement().addEventListener("click", () => {
          electrica = agregarMarker2(coordenada11);
          // map.zoomTo(20.01,[-71.230,-35.003] );
          // AÑADIR UNA LINEA DESDE LA ENTRADA AL GIMNASIO LETS GOOOOOOOO
          muestrate.value = !muestrate.value;
          //crearRuta(rutaGim);
        ...
        cabaña.getElement().addEventListener("click", () => {
          cabaña = agregarMarker2(coordenada12);
          // map.zoomTo(20.01,[-71.230,-35.003] );
          // AÑADIR UNA LINEA DESDE LA ENTRADA AL GIMNASIO LETS GOOOOOOOO
          muestrate.value = !muestrate.value;
          //crearRuta(rutaGim);
        ...
        multiples.getElement().addEventListener("click", () => {
          multiples = agregarMarker2(coordenada13);
        ...
        coe.getElement().addEventListener("click", () => {
          coe = agregarMarker2(coordenada14);
