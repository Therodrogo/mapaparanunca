...
var require_lazyValue = __commonJS({
  "node_modules/@fawmi/vue-google-maps/src/utils/lazyValue.js"(exports, module) {
    module.exports = (fn) => {
      let called = false;
      let result;
      return () => {
...
var import_lazyValue = __toESM(require_lazyValue());
...
function build_component_default(options) {
  ...
  return __spreadValues(__spreadProps(__spreadValues({}, typeof GENERATE_DOC !== "undefined" ? { $vgmOptions: options } : {}), {
    mixins: [mapElementMixin_default],
    props: __spreadValues(__spreadValues({}, props6), mappedPropsToVueProps(mappedProps)),
    render() {
      return "";
    },
    provide() {
      const promise = this.$mapPromise.then((map) => {
        this.$map = map;
        const options2 = __spreadValues(__spreadProps(__spreadValues({}, this.options), {
          map
        ...
        this[instanceName] = ctrArgs ? new (Function.prototype.bind.call(ConstructorObject, null, ...ctrArgs(options2, getPropsValues(this, props6 || {}))))() : new ConstructorObject(options2);
...
// node_modules/@fawmi/vue-google-maps/src/main.js
import Marker from "C:/Users/luism/OneDrive/Escritorio/NodeJs/node_modules/@fawmi/vue-google-maps/src/components/marker.vue";
import GMapCluster from "C:/Users/luism/OneDrive/Escritorio/NodeJs/node_modules/@fawmi/vue-google-maps/src/components/cluster.vue";
import InfoWindow from "C:/Users/luism/OneDrive/Escritorio/NodeJs/node_modules/@fawmi/vue-google-maps/src/components/infoWindow.vue";
import Map from "C:/Users/luism/OneDrive/Escritorio/NodeJs/node_modules/@fawmi/vue-google-maps/src/components/map.vue";
...
// node_modules/@fawmi/vue-google-maps/src/main.js
import Autocomplete from "C:/Users/luism/OneDrive/Escritorio/NodeJs/node_modules/@fawmi/vue-google-maps/src/components/autocomplete.vue";
...
function makeGMapApiPromiseLazy(options) {
  ...
  if (options.load) {
    return (0, import_lazyValue.default)(() => {
      if (Env.isServer()) {
        return new Promise(() => {
        }).then(onApiLoaded);
      } else {
    ...
    return (0, import_lazyValue.default)(() => promise);
  }
}
